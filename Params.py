...
parser.add_argument('--n_t', type=int, default=10, help='Number of trucks of instance, i.e. number of loading operations')
...
parser.add_argument('--shuffle_machines', type=bool, default=False, help='Toggle for permute_rows of machine matrix')
