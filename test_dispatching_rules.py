...
def test_dd_tightness(data_set, n_j, n_m, n_t):
    ...
    while tightness <= 2.0:
        ...
        for data in data_set:
            ...
            job_deadlines = generate_deadlines(times=env.dur, lead_times=env.lt, truck_array=env.truck_array,
...
if __name__ == '__main__':
    ...
    if compute_results:
        ...
        for i in range(dataLoaded.shape[0]):
            test_data.append((dataLoaded[i][0], dataLoaded[i][1], dataLoaded[i][2], arrayLoaded[i]))
