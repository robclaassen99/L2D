...
if __name__ == '__main__':
    ...
    parser.add_argument('--run_type', type=str, default='L2D-LeadTime_Loading',
    ...
    path = './SavedNetworkNew/{}.pth'.format(str(params.run_type) + '_' + str(N_JOBS_N) + '_' + str(N_MACHINES_N)
                                             + '_' + str(N_TRUCKS_N) + '_' + str(LOW) + '_' + str(HIGH) + '_'
