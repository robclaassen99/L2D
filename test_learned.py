...
if __name__ == '__main__':
    ...
    parser.add_argument('--Pn_t', type=int, default=5, help='Number of trucks instances to test')
    ...
    parser.add_argument('--Nn_t', type=int, default=5, help='Number of trucks on which to be loaded net are trained')
